import galinhoImg from '../assets/galinho.webp';
import lagoaazulImg from '../assets/lagoaazul.jpg';
import serradomarImg from '../assets/serradomar.png';
...
const places: Place[] = [
  {
    id: 0,
    img: serradomarImg,
    title: 'CAMINHOS DO MAR, São Bernardo do Campo e Cubatão',
    description: 'Além do apelo ecoturístico, a trilha também é um programa histórico-cultural. Em seu percurso, vários monumentos e construções, alguns datados do centenário da Independência do Brasil, em 1922, reconstituem a importância deste caminho na história da interligação entre o litoral e o planalto paulista.'
  },
  {
    id: 1,
    img: lagoaazulImg,
    title: 'Lagoa Azul, Cubatão',
